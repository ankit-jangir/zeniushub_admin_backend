...
module.exports = (sequelize, DataTypes) => {
  class Student extends Model {
    static associate(models) {
      ...
      this.hasOne(models.Student_Enrollment, {
        foreignKey: "student_id",
        as: "enrollment",
      });
    }
  ...
  Student.init(
    {
      ...
      parent_contact_number: {
        ...
        validate: {
          isNumeric: {
            msg: "Parent contact number must contain only numbers",
          },
          len: {
            args: [10, 10],
            msg: "Parent contact number must be exactly 10 digits",
          },
          is: {
            args: /^[6-9]\d{9}$/,
            msg: "Parent contact number must be a valid Indian number starting with 6, 7, 8, or 9",
          },
        },
      },
      father_contact_no: {
